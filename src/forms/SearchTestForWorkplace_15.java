...
public class SearchTestForWorkplace_15 {
    ...
    private JTextField workplaceIdTextField;
    private JButton searchForTestsButton;
    private JButton goBackToMenuButton;
    private JPanel SearchTestForWorkplacePanel;

    public SearchTestForWorkplace_15(menu pMenu, JFrame pFrame, PCRSystem pPcrSystem, OutputForTests pOutput) {
    ...
    public JPanel getSearchTestForWorkplacePanel() {
        return SearchTestForWorkplacePanel;
    }
    ...
    private boolean emptyFields(){
        ...
        if (workplaceIdTextField.getText().equals("")){
            return true;
        }
        return false;
    }
