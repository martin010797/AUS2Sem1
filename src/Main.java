public class Main {
    ...
    public static void main(String[] args) {
        ...
        generator.testInsert(100);
        System.out.println("hello");
        /*BST23<TestData> tree = new BST23<>();
        TestData d = new TestData(10);
        TestData d2 = new TestData(11);
        TestData d3 = new TestData(5);
        TestData d4 = new TestData(20);
        TestData d5 = new TestData(15);
        TestData d6 = new TestData(3);
        TestData d7 = new TestData(2);
        TestData d8 = new TestData(8);
        TestData d9 = new TestData(9);
        TestData d10 = new TestData(30);
